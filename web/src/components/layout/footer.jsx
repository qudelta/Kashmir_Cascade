    ...
    return (
        <footer className="bg-[#0b1810] border-t border-white/10 pt-16 pb-8 relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] md:w-[800px] md:h-[800px] opacity-[0.03] pointer-events-none select-none z-0">
                <img src="/logo-black.png" alt="" className="w-full h-full object-contain invert" />
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 text-center md:text-left">
                    ...
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <div className="flex gap-4">
                            {/* Social Icons */}
                            <a href="https://qudeltasolutions.com" target="_blank" rel="noopener noreferrer" className="size-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-[#1877F2] hover:border-[#1877F2] transition-all transform hover:-translate-y-1">
