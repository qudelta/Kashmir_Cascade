                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-3">
                            ...
                            {/* X (formerly Twitter) */}
                            <a href="https://qudeltasolutions.com" target="_blank" rel="noopener noreferrer" className="size-10 rounded-full bg-white/5 flex items-center justify-center text-white hover:bg-black hover:text-white transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-4">
                            ...
                            <li><Link className="text-white/60 hover:text-primary transition-colors text-sm" href="/blog">Blog</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-4">
                            <li><Link className="text-white/60 hover:text-primary transition-colors text-sm" href="/terms">Terms & Conditions</Link></li>
                            <li><Link className="text-white/60 hover:text-primary transition-colors text-sm" href="/privacy-policy">Privacy Policy</Link></li>
                            <li><Link className="text-white/60 hover:text-primary transition-colors text-sm" href="/cancellation-policy">Cancellation Policy</Link></li>
                            <li><Link className="text-white/60 hover:text-primary transition-colors text-sm" href="/faq">FAQs</Link></li>
                            <li><Link className="text-white/60 hover:text-primary transition-colors text-sm" href="/site-map">Sitemap</Link></li>
                        </ul>
                    </div>
